    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (session != null) {
            if (preferredLocale == null) {
                ...
                session.setAttribute("org.apache.struts2.action.LOCALE", preferredLocale);
                session.setAttribute(
        				(new StringBuilder()).append("javax.servlet.jsp.jstl.fmt.locale").append(".session")
        						.toString(), preferredLocale);
            }
